...
void target_load_properties()
{
    ...
    if (model == "G8342") {
            ...
            property_override("ro.build.description", "G8342-user 8.0.0 47.1.A.12.205 1908034680 release-keys");
            property_override_dual("ro.build.fingerprint", "ro.vendor.build.fingerprint", "Sony/G8342/G8342:8.0.0/47.1.A.12.205/1908034680:user/release-keys");
        } else {
